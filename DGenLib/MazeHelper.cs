namespace DGenLib
{
    public static class MazeHelper
    {
        ...
        public static bool IsRoad(sbyte[,] maze, int x, int y)
        {
            return IsPointInMaze(maze, x, y) && maze[y, x] > 0;
        }

        public static bool IsWall(sbyte[,] maze, int x, int y)
        {
            return IsPointInMaze(maze, x, y) == false || maze[y, x] == 0;
        }

        public static bool IsPointInMaze(sbyte[,] maze, int x, int y)
        {
